...
public abstract class DefaultDBCPConnectionPoolProvider {
	private static final Log log = LogFactory.getLog(DefaultDBCPConnectionPoolProvider.class);
    ...
    protected static GenericObjectPool _pool = null;

	protected DefaultDBCPConnectionPoolProvider() {
		...
		try {
			DefaultDBCPConnectionPoolProvider.DS = setup(
				url, user, password, 
	...
	private static DataSource setup(String connectURI,
		...
		DefaultDBCPConnectionPoolProvider._pool = connectionPool;
	...
	public static void printDriverStats() throws Exception {
		ObjectPool connectionPool = DefaultDBCPConnectionPoolProvider._pool;
	...
	public int getNumLockedProcesses() {
		...
		ResultSet rs = null;
		try {
			con = DefaultDBCPConnectionPoolProvider.DS.getConnection();
